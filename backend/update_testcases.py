"""
Script to update/add testcases to problems
This will DELETE existing testcases and add new ones with proper weights
"""
...
def update_testcases():
    ...
    try:
        ...
        for problem in problems:
            ...
            if existing_count > 0:
                print(
                    f"🗑️  Deleted {existing_count} existing testcase(s) for '{problem.title}'"
                )

            db.commit()

            print(f"➕ Adding new testcases for: {problem.title}")
        ...
        print("\n🎉 All testcases updated successfully!")
...
if __name__ == "__main__":
    print("🚀 Updating testcases for all problems...\n")
    print(
        "⚠️  This will DELETE existing testcases and add new ones with proper weights!\n"
    )
